  ...
  return (
    <div className="legal-container">
      ...
      <div className="legal-content">
        ...
        <p>Esta Política de Privacidad describe cómo Endorfina Express recopila, usa y comparte información al usar nuestros servicios.</p>
        <p><strong>Recopilación de Información:</strong> Recopilamos información que nos proporcionas directamente al crear tu cuenta para ganar puntos o realizar un pedido (como nombre, correo, número telefónico).</p>
        <p>Tus datos están protegidos y bajo ningún motivo vendemos tu información personal a terceros.</p>
      </div>
    </div>
  );
}
